  ...
  function Ideas({ projects, tools }) {
    ...
    return h("div", null,
      h("div", { className: "mb-4 flex flex-wrap items-center gap-2" },
        ...
        h(C.Select, { value: area, onValueChange: (e) => setArea(e.target ? e.target.value : e) },
          h(C.SelectOption, { value: "" }, "All projects"),
          projects.map((p) => h(C.SelectOption, { key: p, value: p }, p))),
        tools.length > 1 && h(C.Select, { value: tool, onValueChange: (e) => setTool(e.target ? e.target.value : e) },
